  ...
  return (
    <div className={`w-full h-[80px] fixed z-50  ${isHeaderExpanded ? 'bg-[#F4EAD1] shadow-md rounded-b-2xl' : ''}`}>
      <div className='md:max-w-[1480px] max-w-[600px] m-auto w-full h-full flex justify-between items-center md:px-0 px-4'>
        ...
        <div className={`${isOpen ? 'block' : 'hidden'} absolute top-4 right-0 mt-16 bg-[#FCA014]/95 w-[35vh] h-[60vh] shadow-lg p-10 rounded-2xl`}>
          <ul className='flex flex-col justify-center items-start pt-15 mt-10 gap-5'>
            ...
            <li>
              <NavLink to='/limited' onClick={handleOnClick} activeClassName='active' className='text-[#F4EAD1] hover:bg-[#2E5099] rounded-2xl text-4xl font-bold flex'>
                期間限定
                <div className='pl-2'>
                  <FaCat />
                </div>
